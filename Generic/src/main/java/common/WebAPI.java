...
public class WebAPI {
    ...
    public String browserstack_accesskey = "ytDjfNfjpkxipqVG6ygi";
    ...
    public WebDriver getLocalDriver(@Optional("mac") String OS, String browserName) {
        if (browserName.equalsIgnoreCase("chrome")) {
            if (OS.equalsIgnoreCase("OS X")) {
                System.setProperty("webdriver.chrome.driver", "/Users/abestaieb/TDD_Frame/Generic/src/mac/chromedriver");
            } else if (OS.equalsIgnoreCase("Windows")) {
                System.setProperty("webdriver.chrome.driver", "/Users/abestaieb/TDD_BCamp_FrameWork/Generic/BrowserDriver/mac/chromedriver1");
            }
            ...
            if (OS.equalsIgnoreCase("OS X")) {
                System.setProperty("webdriver.gecko.driver", "/Users/abestaieb/TDD_Frame/Generic/src/mac/chromedriver");
            } else if (OS.equalsIgnoreCase("Windows")) {
                System.setProperty("webdriver.gecko.driver", "/Users/abestaieb/TDD_BCamp_FrameWork/Generic/BrowserDriver/mac/chromedriver1");
            }
            driver = new FirefoxDriver();
        } else if (browserName.equalsIgnoreCase("ie")) {
            System.setProperty("webdriver.ie.driver", "/Users/abestaieb/TDD_BCamp_FrameWork/Generic/BrowserDriver/mac/chromedriver1");
